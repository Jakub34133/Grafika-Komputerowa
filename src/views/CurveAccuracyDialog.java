 ...
 * @see CircleModel
 */
public class CurveAccuracyDialog extends JDialog {

    // Pole dla dokładoności rysowanej krzywej (0-1)
    private final JTextField curveAccuracyField = new JTextField("0.01");
    ...
    public Double getCurveAccuracy() {
        if(confirmed) {
            return Double.parseDouble(curveAccuracyField.getText());
        }
        return null;
    }

    public CurveAccuracyDialog(JFrame parent) {
    ...
    private JPanel getMainPanel() {
        ...
        panel.add(new JLabel("Dokładność krzywej (od 0 do 1):"));
        panel.add(curveAccuracyField);
    ...
    private Boolean validateFields() {
        Double accuracy = parseField(curveAccuracyField);
        if(accuracy != null) {
