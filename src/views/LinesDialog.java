...
public class LinesDialog extends JDialog {
    ...
    private final JTextField spacingField = new JTextField("10");
    ...
    public Integer getSpacing() {
        if(confirmed) {
            return Integer.parseInt(spacingField.getText());
        }
        return null;
    }
    ...
    private JPanel getMainPanel() {
        ...
        panel.add(new JLabel("Pozycja Y:"));
        panel.add(yField);
        panel.add(new JLabel("Szerokość:"));
        panel.add(widthField);
        panel.add(new JLabel("Odstępy:"));
    ...
    private Boolean validateFields() {
        return parseField(yField) != null &&
                parseField(spacingField) != null &&
